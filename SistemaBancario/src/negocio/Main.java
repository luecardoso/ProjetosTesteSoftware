...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Lucas", 31, "lucas@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Felipe", 34, "felipe@gmail.com", conta02.getId(), true);
